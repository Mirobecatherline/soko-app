  ...
  if (buyer) {
    return (
      <div>
        ...
        <h1>
          Welcome,{" "}
          {buyer.username.charAt(0).toUpperCase() + buyer.username.slice(1)}!
        </h1>
        <br />
        {show ? (
    ...
    return (
      <div id="header-hero">
        ...
        <div class="header-content">
          ...
          <h1>
            welcome to sok<span class="logo-style">o</span> unique store
          </h1>
          <p class="description">
            This is an online store where you can find all in one roof
          </p>
          <div class="button">
            <p>Welcome</p>
          </div>
